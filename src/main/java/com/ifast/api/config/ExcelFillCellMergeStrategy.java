...
//        Cell preCell = cell.getSheet().getRow(curRowIndex - 1).getCell(curColIndex - 1);
        ...
        int curRowIndexcheck=curRowIndex+1;//行号+1处理每五行一合并
        if(curRowIndexcheck % 5==4) {//每五行一合并
            Sheet sheet = writeSheetHolder.getSheet();
            CellRangeAddress cellRangeAddress = new CellRangeAddress(curRowIndex - 4, curRowIndex, curColIndex, curColIndex);
